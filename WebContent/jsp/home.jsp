...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${ctxpath }/one/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="${ctxpath }/one/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="${ctxpath }/one/basic/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="${ctxpath }/one/css/hmstyle.css" rel="stylesheet" type="text/css"/>
	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<div class="nav white">
					<div class="logo"><img src="${ctxpath }/one/images/logo.png" /></div>
					<div class="logoBig">
						<li><img src="${ctxpath }/one/images/logobig.png" /></li>
					</div>

					<div class="search-bar pr">
						<a name="index_none_header_sysc" href="#"></a>
						<form action="../SearchServlet.do" method="post">
							<input id="searchInput" name="goodsName" type="text" placeholder="输入您想要的商品名称" autocomplete="off">
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="${ctxpath }/one/images/ad1.jpg" /></a></li>
								<li class="banner2"><a><img src="${ctxpath }/one/images/ad2.jpg" /></a></li>
								<li class="banner3"><a><img src="${ctxpath }/one/images/ad3.jpg" /></a></li>
								<li class="banner4"><a><img src="${ctxpath }/one/images/ad4.jpg" /></a></li>
			...
			<div class="shopNav">
				<div class="slideall">
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctxpath }/one/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="${ctxpath }/one/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxpath }/one/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxpath }/one/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctxpath }/one/images/moneysmall.jpg" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="${ctxpath }/one/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="${ctxpath }/one/images/TJ.jpg"></img>
								     <p>XXXXXXXXXXXXXXXXXX</p>
							    </a></li>
							    
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="${ctxpath }/one/person/index.html">
									<img src="${ctxpath }/one/images/getAvatar.do.jpg">
								</a>
								<em>
                        ...
                        <div class="advTip"><img src="${ctxpath }/one/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3" ">
							<img src="${ctxpath }/one/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="introduction.html"><img src="${ctxpath }/one/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="${ctxpath }/one/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three">
								<img src="${ctxpath }/one/images/tj2.png "></img>
							</div>
						</div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="${ctxpath }/one/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="${ctxpath }/one/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="${ctxpath }/one/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="${ctxpath }/one/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="${ctxpath }/one/images/act1.png " />								
							</a>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two sug">
								...
								<a href="# "><img src="${ctxpath }/one/images/2.jpg" /></a>
							</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="${ctxpath }/one/images/1.jpg" /></a>
							</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="${ctxpath }/one/images/5.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="${ctxpath }/one/images/3.jpg" /></a>
						</div>
						...
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="${ctxpath }/one/images/4.jpg" /></a>
						</div>
                 ...
                 <div class="clear "></div>  
					...
					<div class="am-g am-g-fixed floodThree ">
						...
						<div class="am-u-sm-4 text-four">
							<a href="# ">
								<img src="${ctxpath }/one/images/6.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>								
						...
						<div class="am-u-sm-4 text-four sug">
							<a href="# ">
								<img src="${ctxpath }/one/images/7.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
						...
						<div class="am-u-sm-6 am-u-md-3 text-five big ">
							<a href="# ">
								<img src="${ctxpath }/one/images/10.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>		
						...
						<div class="am-u-sm-6 am-u-md-3 text-five ">
							<a href="# ">
								<img src="${ctxpath }/one/images/8.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>	
						...
						<div class="am-u-sm-6 am-u-md-3 text-five sug">
							<a href="# ">
								<img src="${ctxpath }/one/images/9.jpg" />
								<div class="outer-con ">
									<div class="title ">
										雪之恋和风大福
									</div>
		...
		<div class="navCir">
			...
			<li><a href="${ctxpath }/one/person/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="${ctxpath }/one/images/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名sl1903</li>
									<li>级&nbsp;别普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="${ctxpath }/one/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="${ctxpath }/one/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="${ctxpath }/one/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script type="text/javascript " src="${ctxpath }/one/basic/js/quick_links.js "></script>
	</body>
